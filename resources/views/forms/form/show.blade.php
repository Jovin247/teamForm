			...
			<div class="sidebar-category">
				...
				<div class="category-content no-padding">
					<ul class="navigation navigation-alt navigation-accordion" data-form="{{ $form->code }}">
                        ...
                        <!-- Your Blade file -->
                        {{-- <li>
                            <a href="javascript:void()" class="question-template">
                                <input type="color" id="colorPicker" style="display: none;">
                           
                                <i class="fa fa-adjust" aria-hidden="true" style="background-color: black; width: 24px; height: 24px;"></i>
                                Color
                            </a>
                        </li> --}}
						...
						<li><a href="javascript:void()" class="question-template" data-id="long-answer"><i class="icon-menu7"></i> Text </a></li>
						<li class="navigation-divider"></li>
...
{{-- @section('page-script')
    ...
    <script>
        ...
        document.getElementById('colorPicker').addEventListener('change', function() {
            ...
            document.querySelector('.fa-adjust').style.backgroundColor = color;
        });
    </script>
...
<script>
    $(document).ready(function() {
        $('.color-picker').change(function() {
            ...
            // Send the selected color value to your Laravel backend using AJAX
            $.ajax({
                type: "POST",
                url: "/save-color", // Replace with your Laravel route
                data: {
                    color: selectedColor
                },
